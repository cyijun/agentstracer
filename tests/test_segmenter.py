"""Tests for clawtrace.segmenter — OpenClaw session segmentation."""
...
from clawtrace.segmenter import (
    _build_exchanges,
    _classify_tool_mode,
...
class TestDetectWorkspaceSwitches:
    def test_cd_command(self):
        msgs = [
            _user("work on clawtrace"),
            _assistant("", tool_uses=[
                _tool_use("bash", {"command": "cd /Users/x/clawtrace && ls"}),
            ]),
            _user("now dataclaw"),
            _assistant("", tool_uses=[
    ...
    def test_file_path_prefix_shift(self):
        msgs = [
            _user("read file"),
            _assistant("", tool_uses=[
                _tool_use("read", {"file_path": "/Users/x/clawtrace/src/main.py"}),
            ]),
    ...
    def test_no_switch_same_project(self):
        msgs = [
            ...
            _user("read other file"),
            _assistant("", tool_uses=[
                _tool_use("read", {"file_path": "/Users/x/clawtrace/tests/test.py"}),
            ]),
        ]
...
class TestSegmentOpenclawSession:
    def test_multi_task_session_splits(self):
        ...
        msgs = [
            ...
            _user("Go to clawtrace, check failing tests", "2026-03-21T09:15:00Z"),
            _assistant("", "2026-03-21T09:15:30Z", tool_uses=[
                _tool_use("bash", {"command": "cd /home/user/clawtrace && pytest"}),
                _tool_use("read", {"file_path": "/home/user/clawtrace/tests/test_parser.py"}),
                _tool_use("edit", {"file_path": "/home/user/clawtrace/tests/test_parser.py"}),
            ...
            _user("Now go to dataclaw and install clawtrace", "2026-03-21T09:25:00Z"),
            _assistant("Installed", "2026-03-21T09:25:30Z", tool_uses=[
                _tool_use("bash", {"command": "cd /home/user/dataclaw && pip install clawtrace"}),
            ]),
