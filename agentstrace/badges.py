...
def compute_risk_badges(session: dict) -> list[str]:
    ...
    # names_detected: require 5+ distinct likely-person names
    # Two filters: allowlist, then code-phrase prefix check
    ...
    # manual_review: based on sensitivity score (raised threshold to reduce noise)
